...
public interface BookingService {
    ...
    List<BookingResponse> getAllBookingsOfUser(Integer bookerId, BookingStateDto state);

    List<BookingResponse> getAllBookingsOfOwner(Integer ownerId, BookingStateDto state);
}
